...
var editorString = "You want to check my Editing Videos? Then just click the videos below : <br><br><div><label>1.My Vote My Rights</label> <br><video src='./assets/FINAL EXENTED CUT.mp4' class='resumeThumbnail' controls></div> <br><br><div><label>2.Memories</label> <br><video src='./assets/MEMORIES .mp4' class='resumeThumbnail' controls></div> ";
