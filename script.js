...
var resumeString = "<img src='images/resumeThumbnail.png' class='resumeThumbnail'><div class='downloadSpace'><div class='pdfname'><img src='images/pdf.png'><label>Tharun_Prakash Resume.pdf</label></div><a href='./assets/tharunprakash_resume.pdf' download='Tharun_Prakash_Resume.pdf'><img class='download' src='images/downloadIcon.svg'></a></div>";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I am currently pursuing MCA degree in Madras University<br><br>I can comfortably write code in following languages :<br><span class='bold'>HTML<br>CSS<br>JAVASCRIPT<br>SQL<br>Python</span><br><br>I've experiance with following frameworks :<span class='bold'><br>BOOTSTRAP<br>WEB2PY<br>FLASk</span><br><br>I use <span class='bold'>WINDOWS</span> as daily driver on my LENOVO IDEAPAD<br>OS:windows 10<br>Favourite IDE:VSCode</span>");
            break;

        case "education":
            sendTextMessage("I am currently pusuing MCA at Madras University<br>Passing Year : 2026<br><br>I have completed my UG degree at A.M.Jain college<br>Passing Year:2024<br>Result:74.48%<br><br>I have completed my Secondary  Higher school at Marya Nivas Higher Sec school<br>Passing Year:2021<br>Result:72.80%<br><br>I have completed my  High school at Aringar Anna Cantonment High school<br>Passing Year:2019<br>Result:56.20%");
            break;
